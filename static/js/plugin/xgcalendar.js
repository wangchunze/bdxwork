...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        //日期和月的函数
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${starttime} – ${endtime} ${icon}</DT><DD><SPAN>${content}</SPAN></DD><DD><SPAN>${description}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; BORDER-RIGHT-COLOR: ${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BORDER-TOP-COLOR:${bdcolor}; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><textarea id="bbit-cal-what" class="_w90p"></textarea></div></div>');
                temparr.push('</td></tr>');
                temparr.push('<tr><th class="cb-key">');
                temparr.push("工作类型", ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div   class="textbox-fill-mid">');
                temparr.push('<div  id="bbit-cal-type" class="pr"><div id="div_select" class="pr div_select clearfix hand"><div class="w70 fl text1" id="text1">日常维护</div><span class="fr pa select_dropdown triangle-all"></span></div>')
                temparr.push('<ul class="select_ul urloption bgWhite pa solidAll w70 none"  id="ul_select1">')
                ...
                temparr.push('<div  id="bbit-cal-type" class="pr"><div id="div_select1" class="pr div_select1 clearfix hand"><div class="w70 fl text1" id="text2">正常：1</div><span class="fr pa select_dropdown triangle-all"></span></div>')
                temparr.push('<ul class="select_ul urloption bgWhite pa solidAll w70 none"  id="ul_select2">')
                temparr.push('<li id="1">正常：1</li><li id="2">客户要求的周末：2</li> <li id="3">节假日：3</li> <li id="6">周末系统优化：6</li><li id="9">节假日系统优化：9</li></ul></div>')
                temparr.push('</div></div></td></tr>');
                temparr.push('</tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/>');
                temparr.push('<input id="bbit-cal-allday" type="hidden"/>');
                temparr.push('<input id="bbit-cal-type" type="hidden"/>');
                temparr.push('<input id="bbit-cal-coefficient" type="hidden"/>');
                ...
                $("#div_select").click(function(){
                    if($('#ul_select1').is(':hidden')){
                        $("#ul_select1").show();
                        $("#ul_select2").hide();//防止select弹出层覆盖问题
                    }else{
                        $("#ul_select1").hide();
                    }
                })
                ...
                $("#ul_select1 li").click(function(){
                    ...
                    $("#bbit-cal-type").val($(this).attr("id"));

                })

                $("#ul_select2").hide();
                $("#ul_select2 li").mouseover(function(){
                    $("#ul_select2").show();
                    $("#ul_select2 li").removeClass("select_blue");
                    $(this).addClass("select_blue");
                })
                $("#div_select1").click(function(){
                    if($('#ul_select2').is(':hidden')){
                        $("#ul_select2").show();
                ...
                $("#bbit-cal-coefficient").val(1);//工时系数
                $("#ul_select2 li").click(function(){
                    $("#ul_select2").hide();
                    $("#text2").html(($(this).text()));
                    $("#bbit-cal-coefficient").val($(this).attr("id"));
                })
                ...
                calbutton.click(function(e) {
                    ...
                    var type = $("#bbit-cal-type").val();
                    var datestart = $("#bbit-cal-start").val();
                    var dateend = $("#bbit-cal-end").val();
                    var coefficient = $("#bbit-cal-coefficient").val();
