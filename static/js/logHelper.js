...
var logDebug = log4js.getLogger('record');
var logInfo = log4js.getLogger('record');
var logWarn = log4js.getLogger('record');
...
exports.use = function(app) {
    ...
    router.use(log4js.connectLogger(logInfo, {level:'debug', format:':method :url'}));
}
